...
Write-Host "`n=== T3: graph-aware RAG final ===" -ForegroundColor Cyan
try {
...
& ".\push_updates.ps1" "fix: overlap-based course title matching in graph hint"
Write-Host "`n=== BLOCK AS DONE ===" -ForegroundColor Green

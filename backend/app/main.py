...
# ===== Merged feature routers: votes / polls / proposals / ratings (auto-added) =====
try:
    from app.api.routes_votes import router as votes_router
    app.include_router(votes_router, prefix="/api", tags=["Votes"])
except Exception as _v_err:
    print(f"WARNING: votes router failed: {_v_err}")
...
try:
    ...
    print(f"WARNING: proposals router failed: {_pr_err}")
